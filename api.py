...
class Mensaje(db.Model):
    ...
    contenido = db.Column(db.String(1000), nullable=False, default="")
...
def obtener_conversacion(id_conversacion):
    ...
    conversacion = Conversacion.get(id_conversacion)
...
def conversar(id_conversacion):
    ...
    mensaje_humano = Mensaje(humano=True, contenido=texto)
    ...
    mensaje_bot = Mensaje(humano=False, contenido=texto_bot)
